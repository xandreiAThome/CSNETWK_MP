...
def send_like(sock:socket, action:str, post_timestamp: str, app_state: AppState):
    ...
    try:
        ...
        if (action == 'LIKE' and original_post.get("LIKED") == 0 and post_timestamp in app_state.received_posts):
        ...
        elif (action == 'UNLIKE' and original_post.get("LIKED") == 1 and post_timestamp in app_state.received_posts):
